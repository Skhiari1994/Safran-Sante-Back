...
public class ConnectionBdReport {
	...
	public Connection bdReport() {
		try {
			return datasource.getConnection(); // spring boot se charge de tout
	...
	public byte[] genererRapportPDF(String param1, String param2, String param3, String param4, String param5)
			throws JRException, IOException {
		try {
	...
	// Vous pouvez inclure la méthode BdReport ici pour gérer la connexion à la base
