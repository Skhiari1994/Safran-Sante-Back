...
public interface DemandeDonsRepository extends JpaRepository<DemandeDons, CleDemandeDons> {
        ...
        @Query(value = "select num_fam, NOM_PREN from famille " +
                        ...
                        "union " +
                        "select 0, 'adhérent' from dual", nativeQuery = true)
        ...
        List<DemandeDonProjection> getDemandeVal(@Param("codSoc") String codSoc,
                        @Param("affectation") String affectation, @Param("natDon") String natDon);
        ...
        List<DemandeDonProjection> getDemandeIndScol(@Param("codSoc") String codSoc,
                        @Param("affectation") String affectation, @Param("natDon") String natDon);
        ...
        List<DemandeDonProjection> getPersIndVirementScol(@Param("codSoc") String codSoc,
                        @Param("datDebloc") String datDebloc, @Param("affectation") String affectation,
                        @Param("natDon") String natDon
