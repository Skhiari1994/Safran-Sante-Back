...
public interface TokenRepository extends JpaRepository<Token, Integer> {
    ...
    void insertToken(@Param("created") String created, @Param("expires") String expires, @Param("token") String token,
            @Param("useid") Long useid, @Param("validatedat") String validatedat);
