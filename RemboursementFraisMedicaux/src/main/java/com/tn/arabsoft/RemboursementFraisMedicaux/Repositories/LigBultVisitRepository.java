...
import com.tn.arabsoft.RemboursementFraisMedicaux.Entities.LigBultVisit;
import com.tn.arabsoft.RemboursementFraisMedicaux.Projections.LigBultVisitProjection;
...
public interface LigBultVisitRepository extends JpaRepository<LigBultVisit, CleLigBultVisit> {
    ...
    List<LigBultVisit> getLigBultVisit(@Param("soc")String soc, @Param("mat")String mat, @Param("numFam")String numFam, @Param("datSoin")String datSoin);
    ...
    List<LigBultVisitProjection> getLigBultVisitCons(@Param("soc")String soc, @Param("mat")String mat, @Param("numFam")String numFam, @Param("datSoin")String datSoin);
    @Modifying
    @Transactional
    ...
    void deleteLigBultVisit(@Param("soc")String soc,@Param("mat")String mat,@Param("fam")String fam,
                          @Param("datSoin")String datSoin,@Param("abrv")String abrv,@Param("datAct")String datAct,@Param("codVisit")String codVisit);
}
