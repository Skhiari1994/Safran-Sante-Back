...
import com.tn.arabsoft.RemboursementFraisMedicaux.Entities.Cle.LigAppArriverCle;
...
import com.tn.arabsoft.RemboursementFraisMedicaux.Service.LigService;
import com.tn.arabsoft.RemboursementFraisMedicaux.Service.RemboursementService;
...
public class RemboursementController {
    ...
    void susp_pret(@RequestParam String soc, @RequestParam String annee, @RequestParam String mat_deb,
    ...
    public List<BordArriverProjection> GetAllBordArriver(@RequestParam String cod_soc) {
        List<BordArriverProjection> getAllBordArriver = bordArriverRepository.GetAllBordArriver(cod_soc);

        return getAllBordArriver;
    }
    ...
    public List<BordEnvoiProjection> EnteteBordEnvoi(@PathVariable String soc) {
        List<BordEnvoiProjection> bordEnvoiProjection = bordEnvoiRepository.EnteteBordEnvoi(soc);
    ...
    /*
     * @GetMapping("/LigActArriverById")
     * public List<LigActArriverProjection> getLigActArriverById(@RequestParam
     * String cod_soc,
     * 
     * @RequestParam String mat_pers,
     * 
     ...
     * 
     * @RequestParam String dat_soin) {
     * List<LigActArriverProjection> ligActArriver =
     * ligActArriverRepository.findLigActArriverById(cod_soc, mat_pers, num_fam,
     * dat_soin);
     * return ligActArriver;
     * }
     */
    ...
    public ResponseEntity<String> saveBordereauComplet(
        ...
        try {
            ...
            if (data.containsKey("bordereau")) {
                bord = objectMapper.convertValue(data.get("bordereau"), BordArriver.class);
            }
    ...
    public List<ControleBordCnamProjection> getControleBordCnam(@RequestParam String cod_soc,
        ...
        List<ControleBordCnamProjection> ControleBordCnam = bultSoinRepository.getControleBordCnam(cod_soc, cod_bord);
    ...
    public List<BordArriverProjection> getEnteteSaisieBordArriverManuCnam(@RequestParam String cod_soc) {
        List<BordArriverProjection> enteteSaisieBordArriver = bordArriverRepository
                .EnteteSaisieBordArriverManuCnam(cod_soc);

        return enteteSaisieBordArriver;
    }

    @GetMapping("/EnteteSaisieLibreCnam")
    public List<BordArriverProjection> EnteteSaisieLibreCnam(@RequestParam String cod_soc) {
        List<BordArriverProjection> enteteSaisieBordArriver = bordArriverRepository.EnteteSaisieLibreCnam(cod_soc);
    ...
    public List<BordArriverProjection> EnteteCalCompteLibreCnam(@RequestParam String cod_soc) {
        List<BordArriverProjection> enteteSaisieBordArriver = bordArriverRepository.EnteteCalCompteLibreCnam(cod_soc);
    ...
    public List<BordArriverProjection> getEnteteSaisieBordArriverManuLibreCnam(@RequestParam String cod_soc) {
        List<BordArriverProjection> enteteSaisieBordArriverManuLibreCnam = bordArriverRepository
                .EnteteSaisieBordArriverManuLibreCnam(cod_soc);

        return enteteSaisieBordArriverManuLibreCnam;
    }
    ...
    public ReponseRegBord regler_bord(@RequestParam String cod_soc, @RequestParam String cod_bord) {
        ReponseRegBord reponseRegBord = remboursementService.regler_bord(cod_soc, cod_bord);
        return reponseRegBord;
    }

    @GetMapping("/cloture_bord")
    public ReponseCloture cloture_bord(@RequestParam String cod_soc, @RequestParam String cod_bord,
            @RequestParam String cod_assur) {
        ReponseCloture reponseCloture = remboursementService.cloture_bord(cod_soc, cod_assur, cod_bord);
        return reponseCloture;
    }


    @GetMapping("/cloture_bord_vir")
    public ReponseCloture cloture_bord_vir(@RequestParam String cod_soc, @RequestParam String cod_bord,
                                       @RequestParam String cod_assur) {
        ReponseCloture reponseCloture = remboursementService.cloture_bord_vir(cod_soc, cod_assur, cod_bord);
        return reponseCloture;
    }
