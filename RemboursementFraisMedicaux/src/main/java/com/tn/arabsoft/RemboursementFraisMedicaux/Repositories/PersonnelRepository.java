...
import com.tn.arabsoft.RemboursementFraisMedicaux.Entities.Cle.ClePersonnel;
import com.tn.arabsoft.RemboursementFraisMedicaux.Entities.Personnel;
import com.tn.arabsoft.RemboursementFraisMedicaux.Projections.AdherentProjection;
import com.tn.arabsoft.RemboursementFraisMedicaux.Projections.FamillePersonnelBultSoin;
import com.tn.arabsoft.RemboursementFraisMedicaux.Projections.PersonnelBultSoinProjection;
import com.tn.arabsoft.RemboursementFraisMedicaux.Projections.PersonnelProjection;
...
public interface PersonnelRepository extends JpaRepository<Personnel, ClePersonnel> {
    ...
    List<AdherentProjection> getListAdherentFamille(@Param("soc")String soc,@Param("mat")String mat,@Param("fam")String fam);
   ...
   /* @Query(value="select p.num_retr,b.mat_pers,p.nom_pers||' '||p.pren_pers nom,b.cod_fil\n" +
    ...
    List<PersonnelBultSoinProjection> getPersonnelBultSoinSaisie(@Param("soc")String soc,@Param("cod_assur")String cod_assur);*/
   ...
   List<PersonnelBultSoinProjection> getPersonnelBultSoinSaisie(@Param("soc") String soc);
    ...
    List<FamillePersonnelBultSoin> getListFamillePersonnelBultSoinLibre(@Param("soc") String soc,@Param("pers") String pers);
    @Query(value="select p.num_retr,p.mat_pers,p.nom_pers||' '||p.pren_pers nom,a.cod_fil\n" +
            "from personnel p ,pers_affil a\n" +
            "where P.cod_soc = :soc\n" +
            "and P.cod_assur = :ass\n" +
    ...
    List<PersonnelBultSoinProjection> getPersonnelBultSoinSaisieLibre(@Param("soc") String soc,@Param("ass")String ass);
    @Query(value="select p.num_retr,b.mat_pers,p.nom_pers||' '||p.pren_pers nom,b.cod_fil\n" +
            "from personnel p ,bult_soin b\n" +
            "where b.cod_soc = :soc\n" +
            "and p.cod_soc = b.cod_soc\n" +
    ...
    List<PersonnelBultSoinProjection> getPersonnelBultSoinSaisieCnam(@Param("soc") String soc,@Param("ass")String mat,@Param("cod_bord")String cod_bord);
    ...
    List<FamillePersonnelBultSoin>  getPrestat(@Param("soc") String soc,@Param("mat")String mat,@Param("cod_bord")String cod_bord);
