...
import com.tn.arabsoft.RemboursementFraisMedicaux.DTO.BulletinDTO;
...
public class BulletinSoinService {
    ...
    @Autowired
    private BultSoinRepository bultSoinRepository;


    public ReponseDatNais get_dat_nais(String wcodSoc, String mat_,String numFam) {
        return jdbcTemplate.execute((Connection connection) -> {
            ...
            try (CallableStatement callableStatement = connection.prepareCall(procedureCall)) {
                ...
                String dat_nais=callableStatement.getString(4);
                reponseDatNais.setDat_nais(dat_nais);
                return reponseDatNais; // Récupération de la date de naissance
            }
        });
    }

    public ReponseGetSexe get_sexe(String wcodSoc, String mat_,String numFam) {
        return jdbcTemplate.execute((Connection connection) -> {
    ...
    public ResponseProcedure get_duree_bulletin(String wdat_soin, String wCOD_ASSUR) {
        return jdbcTemplate.execute((Connection connection) -> {
    ...
    public ReponseGetPlafondMutuelle get_plafond_mutuelle(String soc, String mat, String datSoin,String datNais,String datSaisie) {
        return jdbcTemplate.execute((Connection connection) -> {
    ...
    public ReponseGetPlafondMutuelle get_plafond_cnam(String soc, String mat, String datSoin,String datNais,String codAssur,String datSaisie) {
        return jdbcTemplate.execute((Connection connection) -> {
    ...
    public ReponseCalculMntNet calculer_montant_net(String soc, String mat, String codFil, String codAssur, String abrvAct, String datSoin, BigDecimal mntHnor,Long indice) {
    ...
    public ResponseProcedure verif_indice(String abrc_act_, String cod_fil_,  String cod_assur_, String indice) {
    ...
    public ResponseProcedure verif_vign(String abrc_act_, String cod_fil_,  String cod_assur_,BigDecimal mnt_honor_ , String nbr_vign_) {
    ...
    public ResponseProcedure verif_piece(String abrc_act_, String cod_fil_,  String cod_assur_,BigDecimal mnt_honor_ , String nbr_piece_) {
    ...
    public ReponseVetifModRemb vetif_mod_remb(String soc, String mat, String numFam, String datSoin, String reg_remb_,String parente,String sexe) {
    ...
    public ReponseCalculMntNet calculer_montant_net_app(String soc, String mat, String numFam, String datSoin, BigDecimal mntHnor,String codApp,Long mutMntNet) {
    ...
    public ReponseCalculMntNet calculer_montant_net_visit(String soc, String mat, String codVisit,BigDecimal mntHnor, String datSoin, BigDecimal prixVisit,BigDecimal tauxRemb,BigDecimal sauvNet) {
    ...
    public ReponseCalculMntNet calculer_montant_net_act(String soc, String mat, String codAct,BigDecimal mntHnor, String datSoin,
    ...
    public ReponseCalculMntNet calculer_montant_net_med(String soc, String mat, String codMed,BigDecimal mntHnor, String datSoin,
    ...
    public Map<String, Object> callCreateBordProc(
            ...
            String pMatPers
                ...
                e.printStackTrace();
                return Collections.singletonMap("error", "Failed to execute procedure: " + e.getMessage());
            }
        });
    }
...
/*prep cnam*/
    ...
    public void callModifBord(
        ...
        String procedureCall = "{ call PK_ENVOI.modif_bord_1(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) }"; // Procedure call with an additional output parameter
        ...
        jdbcTemplate.execute((Connection connection) -> {
            try (CallableStatement callableStatement = connection.prepareCall(procedureCall)) {
                ...
                callableStatement.registerOutParameter(11, java.sql.Types.VARCHAR);  // Register the output parameter (e.g., for success message)
                ...
                System.out.println("Procedure executed successfully: " + successMessage);  // Log or process the success message
    ...
    public Map<String, Object> callCreateBord(
        ...
        return jdbcTemplate.execute((ConnectionCallback<Map<String, Object>>) connection -> {
            try (CallableStatement callableStatement = connection.prepareCall("{call PK_ENVOI.create_bord(?, ?, ?, ?, ?, ?, ?, ?,?)}")) {
                // Définition des paramètres d'entrée
                callableStatement.setString(1, pCodAssur);
                callableStatement.setString(2, pCodSoc);
    ...
    public Map<String, Object> callCalculateTotalHonor(
        ...
        return jdbcTemplate.execute((ConnectionCallback<Map<String, Object>>) connection -> {
            try (CallableStatement callableStatement = connection.prepareCall("{call PK_ENVOI.calculate_total_honor(?, ?, ?, ?, ?, ?, ?, ?)}")) {
    ...
    public String callUpdateBultSoin(String codSoc, String matPers, int numFam, LocalDate datSoin, double mntHonor, double mntTot) {
        ...
        try (Connection connection = jdbcTemplate.getDataSource().getConnection();
            ...
            callableStatement.setDate(4,java.sql.Date.valueOf(datSoin)); // Convert java.util.Date to java.sql.Date
            ...
            System.out.println("Procedure update_bult_soin executed successfully.");
