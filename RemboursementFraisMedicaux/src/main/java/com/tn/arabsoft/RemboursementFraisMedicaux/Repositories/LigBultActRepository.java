...
import com.tn.arabsoft.RemboursementFraisMedicaux.Projections.LigBultActProjection;
...
public interface LigBultActRepository extends JpaRepository<LigBultAct, CleLigBultAct> {
    ...
    Long getNumLigAct(@Param("soc")String soc, @Param("mat")String mat, @Param("numFam")Long numFam, @Param("datSoin") LocalDate datSoin);
    ...
    List<LigBultAct> getLigBultAct(@Param("soc")String soc, @Param("mat")String mat, @Param("numFam")String numFam, @Param("datSoin")String datSoin);
    ...
    List<LigBultActProjection> getLigBultActCons(@Param("soc")String soc, @Param("mat")String mat, @Param("numFam")String numFam, @Param("datSoin")String datSoin);
    @Modifying
    @Transactional
    ...
    void deleteLigBultAct(@Param("soc")String soc,@Param("mat")String mat,@Param("fam")String fam,
                       @Param("datSoin")String datSoin,@Param("abrv")String abrv,@Param("numLig")String numLig,@Param("datAct")String datAct,@Param("codAct")String codAct);
}
