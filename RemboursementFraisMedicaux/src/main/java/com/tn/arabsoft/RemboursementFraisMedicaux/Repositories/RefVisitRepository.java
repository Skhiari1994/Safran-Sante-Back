...
import com.tn.arabsoft.RemboursementFraisMedicaux.Entities.RefVisit;
import com.tn.arabsoft.RemboursementFraisMedicaux.Projections.AppareilProjection;
import com.tn.arabsoft.RemboursementFraisMedicaux.Projections.VisitProjection;
...
public interface RefVisitRepository extends JpaRepository<RefVisit,String> {
    ...
    List<VisitProjection> getVisit(@Param("parente")String parente,@Param("sexe")String sexe,@Param("codFil")String codFil,@Param("codAssur")String codAssur);
