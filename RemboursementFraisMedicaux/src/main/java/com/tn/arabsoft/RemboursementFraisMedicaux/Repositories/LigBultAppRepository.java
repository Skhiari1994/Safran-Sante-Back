...
import com.tn.arabsoft.RemboursementFraisMedicaux.Entities.LigBultApp;
import com.tn.arabsoft.RemboursementFraisMedicaux.Projections.LigBultAppProjection;
...
public interface LigBultAppRepository extends JpaRepository<LigBultApp, CleLigBultApp> {
    ...
    Long getNumLigApp(@Param("soc")String soc, @Param("mat")String mat, @Param("numFam")Long numFam, @Param("datSoin") LocalDate datSoin, @Param("codApp")String codApp);
    ...
    List<LigBultApp> getLigBultApp(@Param("soc")String soc, @Param("mat")String mat, @Param("numFam")String numFam, @Param("datSoin")String datSoin);
    ...
    List<LigBultAppProjection> getLigBultAppCons(@Param("soc")String soc, @Param("mat")String mat, @Param("numFam")String numFam, @Param("datSoin")String datSoin);
    ...
    void deleteLigBultApp(@Param("soc")String soc,@Param("mat")String mat,@Param("fam")String fam,
                          @Param("datSoin")String datSoin,@Param("abrv")String abrv,@Param("numLig")String numLig,@Param("codApp")String codApp);
}
