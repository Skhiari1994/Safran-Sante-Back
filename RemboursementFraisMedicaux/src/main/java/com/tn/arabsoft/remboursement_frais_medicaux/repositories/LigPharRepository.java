...
public interface LigPharRepository extends JpaRepository<LigPhar, CleLigPhar> {
        ...
        List<LigPhar> getLigPhar(@Param("soc") String soc, @Param("mat") String mat, @Param("numFam") String numFam,
        ...
        List<LigPharProjectionCons> getLigPharCons(@Param("soc") String soc, @Param("mat") String mat,
        ...
        void deleteLigPhar(@Param("soc") String soc, @Param("mat") String mat, @Param("fam") String fam,
                        @Param("datSoin") String datSoin, @Param("med") String med, @Param("numLig") String numLig);
}
