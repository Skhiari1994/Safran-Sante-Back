...
public interface LigBultMedRepository extends JpaRepository<LigBultMed, CleLigBultMed> {
        ...
        Long getNumLigMed(@Param("soc") String soc, @Param("mat") String mat, @Param("numFam") Long numFam,
                        @Param("datSoin") LocalDate datSoin, @Param("codMed") String codMed);
        ...
        List<LigBultMed> getLigBultMed(@Param("soc") String soc, @Param("mat") String mat,
        ...
        List<LigBultMedProjection> getLigBultMedCons(@Param("soc") String soc, @Param("mat") String mat,
                        @Param("numFam") String numFam, @Param("datSoin") String datSoin);
