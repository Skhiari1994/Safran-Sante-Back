...
public class BultSoinDTO {
    ...
    public String getNumFam() {
        return numFam;
    }

    public void setNumFam(String numFam) {
        this.numFam = numFam;
    }

    public LocalDate getDatSoin() {
        return datSoin;
    }

    public void setDatSoin(LocalDate datSoin) {
        this.datSoin = datSoin;
    }

    public BigDecimal getTotRemb() {
        return totRemb;
    }

    public void setTotRemb(BigDecimal totRemb) {
        this.totRemb = totRemb;
    }
