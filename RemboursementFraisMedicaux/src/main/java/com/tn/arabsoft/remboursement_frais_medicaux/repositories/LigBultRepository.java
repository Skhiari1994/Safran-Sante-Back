...
public interface LigBultRepository extends JpaRepository<LigBult, LigBultCle> {
        ...
        List<LigBult> getLigBult(@Param("soc") String soc, @Param("mat") String mat, @Param("numFam") String numFam,
        ...
        List<LigBultProjection> getLigBultCons(@Param("soc") String soc, @Param("mat") String mat,
        ...
        void deleteLigBult(@Param("soc") String soc, @Param("mat") String mat, @Param("fam") String fam,
